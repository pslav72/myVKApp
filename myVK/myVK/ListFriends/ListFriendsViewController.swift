...
class ListFriendsViewController: UITableViewController {
    ...
    var friends = [
        User(name: "Oleg", image: UIImage(systemName: "person")),
        User(name: "Vanja", image: UIImage(systemName: "person.2")),
        User(name: "Stas", image:  UIImage(systemName: "person.3")),
        User(name: "Roma", image:  UIImage(systemName: "person")),
    ]
